            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid col-md-12">
						...
						<h3>Selecione o simulado abaixo para responder</h3>
						<?php
							...
							<table class="table table-striped">
								  ...
								  <tbody>	
										<?php
											...
											$sql="select * from vsimulados where cod_aluno = ".$_SESSION['codaluno']." and finalizado = 'n' group by cod_simulado";
											//echo $sql;
													...
													if($consulta->num_rows>0){
														while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
															...
															echo '<tr>
																	...
																	<td>
																		<a title="Responder" href="responder.php?id='.$linha['cod_simulado'].'" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Responder</a>
