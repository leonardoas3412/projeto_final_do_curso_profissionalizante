...
<?php
	...
	if(isset($_GET['cod'])){
		...
		$sql= "select * from tb_escola where cod_escola = $cod";
            ...
            <div id="layoutSidenav_content">
                <main>
					...
					<a class="btn btn-info" href="busAluno.php"><i class="fa fa-angle-left"></i> Voltar</a>
                        <h1 class="mt-4"> Alterar cadastro de Escola</h1>
							<?php
								if(isset($_GET['mess'])){
									if($_GET['mess']=='erro'){			 
							...
							<form name="form1" id="form1" method="POST" action="altEscola.php" onsubmit="return validar()">
							<input name="cod" type="hidden" value="<?php echo $linha['cod_escola'];?>">
