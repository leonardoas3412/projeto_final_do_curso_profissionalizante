            ...
            <div id="layoutSidenav_content">
                <main>
					...
					<a class="btn btn-info" href="../adm/dist/cadastro.php"><i class="fa fa-angle-left"></i> Voltar</a>
                        <h1 class="mt-4"> Cadastro de Alunos</h1>
							<?php
								if(isset($_GET['mess'])){
									if($_GET['mess']=='erro'){			 
							...
							<form name="form1" id="form1" method="POST" action="addAluno2.php" onsubmit="return validar()">
								...
								<div class="form-group">
									<label>E-mail</label>  
									<input class="form-control" type="email" name="email" placeholder="Insira seu e-mail" required aria-required="true" required>
								</div>
								<div class="form-group">
									<label>Matrícula</label>  
									<input class="form-control" type="number" name="matricula" placeholder="Insira sua matrícula" required>
								</div>
								<div class="form-group">
