...
<div class="w3-container w3-teal">
  <h2>CRIAR NOVA CONTA - Aluno(a)</h2>
</div>
<form class="w3-container w3-card-4" name="form1" id="form1" method="POST" action="addAluno.php">
  ...
  <div class="w3-section">
    ...
    <input class="w3-input" type="number" name="matricula" placeholder="Insira sua matrícula" required>
  </div>
  <div class="w3-section">
