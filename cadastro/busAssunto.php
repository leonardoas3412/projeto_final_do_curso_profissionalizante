            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4"> Busca de Assuntos</h1>
							<?php
							...
							<form name="form1" method="POST" action="busAssunto.php"> 
									...
									<tbody>
										<?php
											if(isset($_POST['texto'])){
												...
												$sql="select * from tb_assunto where descricao like '%$texto%'";
													...
													if($consulta->num_rows>0){
														while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
															echo '<tr>
																	...
																	<td>
																		<a title="Alterar" onclick="validaraltera('.$linha['cod_assunto'].')"href="#" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
																		<a title="Excluir" onclick="validardelete('.$linha['cod_assunto'].')" href="#" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
																	</td>
		...
		<script>
			function validardelete(cod){
				if(confirm('Deseja excluir este registro?')){
					location.href= "exAssunto.php?cod="+cod;
				}
			}
			function validaraltera(cod){
				if(confirm('Deseja alterar este registro?')){
					location.href= "cadalteraAssunto.php?cod="+cod;
				}
			}
	    </script>
	</body>
