...
<?php
	...
	if(isset($_GET['cod'])){
		...
		$sql= "select * from tb_aluno where cod_aluno = $cod";
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
					...
					<a class="btn btn-info" href="busAluno.php"><i class="fa fa-angle-left"></i> Voltar</a>
                        <h1 class="mt-4"> Alterar cadastro de Alunos</h1>
							<?php
								if(isset($_GET['mess'])){
									if($_GET['mess']=='erro'){			 
							...
							<form name="form1" id="form1" method="POST" action="altAluno.php" onsubmit="return validar()">
							<input name="cod" type="hidden" value="<?php echo $linha['cod_aluno'];?>">
								...
								<div class="form-group">
									...
									<input value=" <?php echo $linha['matricula']; ?>" class="form-control" type="text" name="matricula" placeholder="Insira sua matrícula" required>
								</div>
