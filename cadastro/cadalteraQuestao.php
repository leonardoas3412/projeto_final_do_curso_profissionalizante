...
<?php
	...
	if(isset($_GET['cod'])){
		...
		$sql= "select * from tb_questao where cod_questao = $cod";
                ...
                <main>
					...
					<a class="btn btn-info" href="../adm/dist/cadastro.php"><i class="fa fa-angle-left"></i> Voltar</a>
                        <h1 class="mt-4"> Cadastro de Questões</h1>
							...
							<form name="form1" id="form1" method="POST" action="altQuestao.php" onsubmit="return validar()">
								<input name="cod" type="hidden" value="<?php echo $linha['cod_questao'];?>">
								<div class="form-group">
									<label>Disciplina</label>
									<select value=" <?php echo $linha['disciplina']; ?>" class="form-control" name="disciplina" id="disciplina" >
								...
								<div class="form-group">
									...
									<select value=" <?php echo $linha['assunto']; ?>" class="form-control" name="assunto" id="assunto" >
								...
								<div class="form-group">
									...
									<textarea value=" <?php echo $linha['descricao']; ?>" class="ckeditor" cols="80" id="descricao" name="descricao" rows="10"><?php echo $linha['descricao']; ?></textarea>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Item A</label>  
									<input   type="text" value=" <?php echo $linha['item_A']; ?>" name="item_a" id="item_a" class="form-control" placeholder="Insira o conteúdo do item" required  >
								</div>
								<div class="form-group">
									<label>Item B</label>  
									<input   type="text" value=" <?php echo $linha['item_B']; ?>" name="item_b" id="item_b" class="form-control" placeholder="Insira o conteúdo do item" required  >
								</div>
								<div class="form-group">
									<label>Item C</label>  
									<input  type="text" value=" <?php echo $linha['item_C']; ?>" name="item_c" id="item_c" class="form-control" placeholder="Insira o conteúdo do item" required  >
								</div>
								<div class="form-group">
									<label>Item D</label>  
									<input  type="text" value=" <?php echo $linha['item_D']; ?>" name="item_d" id="item_d" class="form-control" placeholder="Insira o conteúdo do item" required >
								</div>
								<div class="form-group">
									<label>Item E</label>  
									<input  type="text" value=" <?php echo $linha['item_E']; ?>" name="item_e" id="item_e" class="form-control" placeholder="Insira o conteúdo do item" required >
								</div>
								<div class="form-group">
									...
									<select  name="resp_correta" id="resp_correta" class="form-control">
										<option value="<?php echo $linha['resp_correta']; ?>"><?php echo $linha['resp_correta']; ?></option>
