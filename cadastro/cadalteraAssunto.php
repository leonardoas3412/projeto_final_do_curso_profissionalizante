...
<?php
	...
	if(isset($_GET['cod'])){
		...
		$sql= "select * from tb_assunto where cod_assunto = $cod";
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
					...
					<a class="btn btn-info" href="busAssunto.php"><i class="fa fa-angle-left"></i> Voltar</a>
                        <h1 class="mt-4"> Alterar cadastro de Assunto</h1>
							<?php
								if(isset($_GET['mess'])){
									if($_GET['mess']=='erro'){			 
							...
							<form name="form1" id="form1" method="POST" action="altAssunto.php" onsubmit="return validar()">
							<input name="cod" type="hidden" value="<?php echo $linha['cod_assunto'];?>">
							<input name="cod" type="hidden" value="<?php echo $linha['cod_disc'];?>">
								
								<input name="assunto" type="text" value="<?php echo $linha['descricao'];?>">
								<p></p>
