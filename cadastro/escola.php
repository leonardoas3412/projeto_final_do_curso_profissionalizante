...
<header class="w3-container w3-theme w3-padding" id="myHeader">
  ...
  <div class="w3-center">
  <h3>SISTEMA AVALIATIVO DE SIMULADOS VEST</h3>
  <h1 class="w3-xxxlarge w3-animate-bottom">SASV</h1>
    <div class="w3-padding-32">
		<div id="icons">
			<a href="https://www.instagram.com/turma3info/" class="fa fa-instagram" title="Instagram da Turma"></a>
...
<form class="w3-container w3-card-4" name="form1" id="form1" method="POST" action="addProf.php">
  ...
  <div class="w3-section">
    ...
    <!-- <input class="w3-input" type="text" name="cidade" placeholder="Insira o nome da cidade localizada a sua escola" required> -->
		<select class="w3-select" name="cidade" id="cidade" style="width:99%" >
		  <option value="0" disabled selected>Informe o nome da cidade localizada a sua escola ...</option>
			<?php
