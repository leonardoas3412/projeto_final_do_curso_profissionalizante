            ...
            <div id="layoutSidenav_content">
                <main>
					...
					<a class="btn btn-info" href="../adm/dist/cadastro.php"><i class="fa fa-angle-left"></i> Voltar</a>
                        <h1 class="mt-4"> Cadastro de Escolas</h1>
							<?php
								if(isset($_GET['mess'])){
									if($_GET['mess']=='erro'){			 
							...
							<form name="form1" id="form1" method="POST" action="addAluno2.php" onsubmit="return validar()">
								<div class="form-group">
                                   ...
                                   <!-- <input class="w3-input" type="text" name="cidade" placeholder="Insira o nome da cidade localizada a sua escola" required> -->
		                               <select class="w3-select" name="cidade" id="cidade" style="width:99%" >
		                                 <option value="0" disabled selected>Informe o nome da cidade a sua escola está localizada ...</option>
