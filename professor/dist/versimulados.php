								...
								if(isset($_GET['delete'])){
									if($_GET['delete']=='ok'){
										echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
												  <strong>Atenção!</strong> Simulado apagado com sucesso. 
									...
									if($_GET['delete']=='erro'){
										echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
												  <strong>Atenção!</strong> Erro ao excluir simulado. 
												  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
													<span aria-hidden="true">&times;</span>
												  </button>
												</div>';
							...
							<table class="table table-striped">
								  ...
								  <tbody>	
										<?php
											...
											$sql="select tb_assunto.descricao as assunto, tb_disc.descricao as disciplina, tb_simulado.* from tb_simulado 
																			INNER JOIN tb_disc ON tb_disc.cod_disc = tb_simulado.cod_disc
																		    INNER JOIN tb_assunto ON tb_assunto.cod_assunto = tb_simulado.cod_assunto
																			where cod_prof = ".$_SESSION['codprof']." group by cod_simulado";
													...
													if($consulta->num_rows>0){
														while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
															echo '<tr>
																	...
																	<td>
																		<a title="ver" href="ver.php?id='.$linha['cod_simulado'].'" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> </a>
																		<a title="Excluir" href="delete.php?id='.$linha['cod_simulado'].'" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>	
																	</td>
