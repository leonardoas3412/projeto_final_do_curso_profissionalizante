...
if(isset($_POST['qtd'])){
	...
	$sql = "insert into tb_simulado (cod_simulado,cod_aluno,cod_assunto,cod_disc,data, hora,qtd_questao,qtd_acerto, cod_prof)
						     values (null,null,'$assunto','$disciplina','$data','$hora','$qtd',0, '$codprof')";
	//echo $sql;				  
	//executando o insert
